...
public class PolicyTermServiceTest {
    ...
    @InjectMocks
    PolicyTermServiceImpl policyTermService;
    ...
    void findPolicyTermTest() {
        ...
        PolicyTerm policyTerm = PolicyTerm.builder()
        ...
        assertThat(result.getTitle()).isEqualTo(Objects.requireNonNull(policyTerm).getPolicyType().getTitle().getValue());
