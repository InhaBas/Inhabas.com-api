...
public class MemberTest {
    ...
    public static Member chiefMember() {
        return new Member(
                ...
                , SchoolInformation.ofUnderGraduate("컴퓨터공학과", 3, 2)
    ...
    public static Member executivesMember() {
        return new Member(
                ...
                , SchoolInformation.ofUnderGraduate("컴퓨터공학과", 4, 2)
    ...
    public static Member basicMember1() {
        return new Member(
                ...
                , SchoolInformation.ofUnderGraduate("건축공학과", 3, 3)
    ...
    public static Member basicMember2() {
        return new Member(
                ...
                , SchoolInformation.ofUnderGraduate("경영학과", 2, 2)
                , new IbasInformation(BASIC));
    }
