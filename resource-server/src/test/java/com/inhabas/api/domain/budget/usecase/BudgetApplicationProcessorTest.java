...
public class BudgetApplicationProcessorTest {
    ...
    @InjectMocks
    private BudgetApplicationProcessorImpl processor;

    @Mock
    private BudgetApplicationRepository applicationRepository;
    @Mock
    private BudgetHistoryRepository historyRepository;

    @DisplayName("대기중인 요청을 승인한다.")
    @Test
    public void waitingToApproveTest() {
        //given
        BudgetSupportApplication application = BudgetSupportApplication.builder()
                .title("title")
