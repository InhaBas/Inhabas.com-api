...
public class BudgetApplicationProcessorTest {
    ...
    public void waitingToApproveTest() {
        ...
        Assertions.assertThat(status).isEqualTo(ApplicationStatus.APPROVED);
    }
    ...
    public void waitingToDenyTest() {
        ...
        ApplicationStatus status =
               (ApplicationStatus) ReflectionTestUtils.getField(application, "status");
        Assertions.assertThat(status).isEqualTo(ApplicationStatus.DENIED);
    }
    ...
    public void rejectReasonIsNecessaryToDenyTest() {
        ...
        // then
        Assertions.assertThatThrownBy(() -> processor.process(1, request, new StudentId("18165249")))
    ...
    public void waitingToProcessTest() {
        ...
        ApplicationStatus status =
               (ApplicationStatus) ReflectionTestUtils.getField(application, "status");
        Assertions.assertThat(status).isEqualTo(ApplicationStatus.PROCESSED);
    }
