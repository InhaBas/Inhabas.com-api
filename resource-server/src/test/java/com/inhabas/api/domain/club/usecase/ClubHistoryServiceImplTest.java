...
public class ClubHistoryServiceImplTest {
  ...
  @InjectMocks ClubHistoryServiceImpl clubHistoryService;
  @Mock ClubHistoryRepository clubHistoryRepository;
  ...
  void writeClubHistory_Success() {
    ...
    given(clubHistoryRepository.save(any(ClubHistory.class)))
        .willAnswer(
            invocation -> {
  ...
  void findClubHistory_Success() {
    ...
    assertThat(clubHistoryDto)
        .as("clubHistoryDto's title and content are equal to clubHistory")
