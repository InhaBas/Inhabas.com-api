...
public class MemberRepositoryTest {
    ...
    public void update() {
        ...
        //when
        Member param = new Member(MEMBER1.getId(), "유동현", "010-1111-2222", "", SchoolInformation.ofStudent("건축공학과", 2), member.getIbasInformation());
    ...
    public void 같은_전화번호_저장_예외() {
        ...
        Member samePhoneMember = Member.builder()
                ...
                .schoolInformation(SchoolInformation.ofStudent("전자공학과", 3))
                .build();
    ...
    public void 전화번호가_존재한다() {
        ...
        Member member = Member.builder()
                ...
                .name("유동현")
                .picture("")
                .schoolInformation(SchoolInformation.ofStudent("공간정보공학과", 1))
