...
public class MenuNameTest {
  ...
  public void MenuName_is_too_long() {
    ...
    // when
    assertThrows(IllegalArgumentException.class, () -> new MenuName(menuName));
  }

  @DisplayName("메뉴이름은 null 일 수 없다.")
  @Test
  public void MenuName_cannot_be_null() {
    assertThrows(IllegalArgumentException.class, () -> new MenuName(null));
  }

  @DisplayName("메뉴이름은 빈 문자열일 수 없다.")
  @Test
  public void MenuName_cannot_be_blank() {
    assertThrows(IllegalArgumentException.class, () -> new MenuName(" "));
  }
}
