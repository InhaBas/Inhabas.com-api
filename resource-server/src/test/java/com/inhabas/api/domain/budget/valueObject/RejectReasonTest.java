...
public class RejectReasonTest {
  ...
  public void tooLongRejectReasonTest() {
    ...
    // then
    assertThrows(IllegalArgumentException.class, () -> new RejectReason(rejectString));
  }

  @DisplayName("거부이유는 null 일 수 없습니다.")
  @Test
  public void rejectReasonCannotBeNullTest() {
    assertThrows(IllegalArgumentException.class, () -> new RejectReason(null));
  }

  @DisplayName("거부이유는 빈 문자열일 수 없습니다.")
  @Test
  public void rejectReasonCannotBeBlankTest() {
    assertThrows(IllegalArgumentException.class, () -> new RejectReason("\t"));
  }
}
