...
public class CommentRepositoryTest {
    ...
    public void setUp() {
        ...
        albumBoard = em.persist(
                AlbumExampleTest.getAlbumBoard1(menu)
                        .writtenBy(boardWriter, AlbumBoard.class)
        );
    ...
    public void Hierarchical_Comment_List() {
        ...
        //when
        List<CommentDetailDto> commentList = commentRepository.findAllByParentBoardIdOrderByCreated(albumBoard.getId());
