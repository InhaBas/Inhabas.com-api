...
public class SignUpServiceTest {
  ...
  @Mock private MajorInfoService majorInfoService;
  @Mock private MemberRepository memberRepository;
  @Mock private MemberSocialAccountRepository memberSocialAccountRepository;
  @Mock private MemberService memberService;
  @Mock private SignUpScheduler signUpScheduler;
  ...
  public void noSavedMemberProfileTest() {
    ...
    assertThat(loadedForm).usingRecursiveComparison().isEqualTo(expectResult);
  }
  ...
  public void getMajorInfoTest() {
    // given
    given(majorInfoService.getAllMajorInfo())
        .willReturn(List.of(new MajorInfoDto(2, "공대", "전기공학과")));
  ...
  public void notYetWriteAnswersTests() {
    ...
    // then
    assertThrows(
        NotWriteAnswersException.class,
  ...
  public void notYetWriteProfileTests() {
    ...
    // then
    assertThrows(
        NotWriteProfileException.class, () -> signUpService.completeSignUp(null, member.getId()));
  }
  ...
  public void saveAnswers() {
    // given
    Member member = signingUpMemberAfterProfile();
    ArrayList<AnswerDto> submittedAnswers =
        new ArrayList<>() {
          {
