...
public class NormalBoardRepositoryTest {
  ...
  @Autowired NormalBoardRepository boardRepository;
  ...
  //
  //        //when
  //        Page<BoardDto> freeBoards = boardRepository.findAllByMenuId(freeBoardMenuId,
  // Pageable.ofSize(5));
  //        Page<BoardDto> noticeBoards = boardRepository.findAllByMenuId(noticeBoardMenuId,
  // Pageable.ofSize(5));
  //
  //        //then
