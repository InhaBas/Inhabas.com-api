...
public class AnswerServiceTest {
  ...
  private static final ArrayList<Questionnaire> questionnaires =
      new ArrayList<>() {
        {
  ...
  private static final ArrayList<Answer> savedAnswers =
      new ArrayList<>() {
        {
  ...
  private static final ArrayList<AnswerDto> submittedAnswers =
      new ArrayList<>() {
        {
  ...
  public void saveAnswersTest() {
    ...
    given(questionnaireRepository.findById(1L))
        .willReturn(Optional.ofNullable(questionnaires.get(0)));
    given(questionnaireRepository.findById(2L))
        .willReturn(Optional.ofNullable(questionnaires.get(1)));
    given(questionnaireRepository.findById(3L))
        .willReturn(Optional.ofNullable(questionnaires.get(2)));
  ...
  public void getAnswersTest() {
    ...
    // then
    assertThat(returnedDTOs).usingRecursiveComparison().isEqualTo(submittedAnswers);
  }
}
