...
public class BudgetHistoryServiceTest {
    ...
    public void cannotModifyBudgetHistoryOfOtherCFO() {
        ...
        Assertions.assertThatThrownBy(() -> budgetHistoryService.modifyHistory(form, currentCFO))
               .isInstanceOf(AccessDeniedException.class)
               .hasMessage("다른 담당자가 작성한 내역은 수정할 수 없습니다!");
    }
    ...
    public void raiseNotFoundExceptionWhenModifyingTest() {
        ...
        Assertions.assertThatThrownBy(
               ...
               .isInstanceOf(BudgetHistoryNotFoundException.class)
               .hasMessage("cannot find such budget history!");
    }
    ...
    public void cannotDeleteBudgetHistoryTest() {
        ...
        // when
        Assertions.assertThatThrownBy(() -> budgetHistoryService.deleteHistory(historyId, currentCFO))
               .isInstanceOf(HistoryCannotModifiableException.class)
               .hasMessage("다른 담당자가 작성한 내역은 수정할 수 없습니다!");
    ...
    public void cannotFindBudgetHistoryFindById() {
        ...
        // when
        Assertions.assertThatThrownBy(() -> budgetHistoryService.getHistory(2))
               .isInstanceOf(BudgetHistoryNotFoundException.class)
               .hasMessage("cannot find such budget history!");
