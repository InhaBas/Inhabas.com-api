...
public class SaveClubActivityDtoTest {
    ...
    public void validationTest() {
        //given
        SaveClubActivityDto saveClubActivityDto = SaveClubActivityDto.builder()
                .title("")
                .content("")
                .files(null)
                .build();
        ...
        //when
        Set<ConstraintViolation<SaveClubActivityDto>> violations = validator.validate(saveClubActivityDto);
