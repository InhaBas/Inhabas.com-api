...
public class LectureServiceImplTest {
  ...
  @InjectMocks private LectureServiceImpl service;
  ...
  public void createTest() {
    ...
    LectureRegisterForm form =
        LectureRegisterForm.builder()
            .title("절권도 배우기")
  ...
  public void cannotModifyTest() {
    ...
    ReflectionTestUtils.setField(origin, "id", 1);
    given(repository.findById(anyInt())).willReturn(Optional.of(origin));
    LectureUpdateForm form =
        LectureUpdateForm.builder()
            .id(1)
            .title("절권도 배우기")
            .applyDeadLine(LocalDateTime.of(9011, 1, 1, 1, 1, 1))
            .curriculumDetails("1주차: 빅데이터에 기반한 공격패턴분석<br> 2주차: ...")
    ...
    Assertions.assertThrows(
        LectureCannotModifiableException.class, () -> service.update(form, attacker));
  ...
  public void cannotDeleteTest() {
    ...
    // when
    Assertions.assertThrows(
        LectureCannotModifiableException.class, () -> service.delete(1, attacker));
  ...
  public void getTest() {
    ...
    // given
    LectureDetailDto expectedDto =
        LectureDetailDto.builder()
            .title("절권도 강의")
  ...
  public void cannotTerminateLectureTest() {
    ...
    Assertions.assertThrows(
        IllegalArgumentException.class, () -> service.approveOrDeny(1, request));
  }
