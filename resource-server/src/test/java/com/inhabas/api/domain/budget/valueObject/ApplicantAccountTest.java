...
public class ApplicantAccountTest {
  ...
  public void tooLongApplicantAccountTest() {
    ...
    // then
    assertThrows(IllegalArgumentException.class, () -> new ApplicantAccount(accountString));
  }

  @DisplayName("계좌정보는 null 일 수 없습니다.")
  @Test
  public void applicantAccountCannotBeNull() {
    assertThrows(IllegalArgumentException.class, () -> new ApplicantAccount(null));
  }

  @DisplayName("계좌정보는 빈 문자열일 수 없습니다.")
  @Test
  public void applicantAccountCannotBeNullBlank() {
    assertThrows(IllegalArgumentException.class, () -> new ApplicantAccount("\t"));
  }
}
