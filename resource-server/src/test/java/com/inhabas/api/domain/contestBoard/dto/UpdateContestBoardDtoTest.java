...
public class UpdateContestBoardDtoTest {
  ...
  public void FieldsAreNullError() {
    // given
    UpdateContestBoardDto updateContestBoardDto =
        new UpdateContestBoardDto(null, null, null, null, null, null, null);

    // when
    Set<ConstraintViolation<UpdateContestBoardDto>> violations =
        validator.validate(updateContestBoardDto);
  ...
  public void FieldsAreBlankError() {
    ...
    // then
    assertThat(errorMessage).contains("제목을 입력하세요.", "본문을 입력하세요.", "협회기관을 입력하세요.", "공모전 주제를 입력하세요.");
  }
