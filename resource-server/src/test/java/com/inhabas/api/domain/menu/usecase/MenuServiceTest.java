...
public class MenuServiceTest {
  ...
  public void getMenuInfoByIdTest() {
    ...
    assertThat(returnedMenuDto).usingRecursiveComparison().isEqualTo(MenuDto.convert(existMenu));
  }
  ...
  public void FailToGetMenuInfoByIdTest() {
    ...
    Assertions.assertThrows(
        NotFoundException.class, () -> menuService.getMenuInfoById(new MenuId(1)));
  }
}
