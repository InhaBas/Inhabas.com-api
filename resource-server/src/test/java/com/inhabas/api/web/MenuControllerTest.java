...
public class MenuControllerTest {
  ...
  public void getTotalMenuInfoTest() throws Exception {
    given(menuService.getAllMenuInfo())
        .willReturn(
            List.of(
                new MenuGroupDto(
                    1,
                    "IBAS",
                    List.of(new MenuDto(new MenuId(6), 1, "동아리 소개", MenuType.INTRODUCE, "")))));
  ...
  public void getMenuInfoByIdTest() throws Exception {
    ...
    given(menuService.getMenuInfoById(any()))
        .willReturn(new MenuDto(new MenuId(6), 1, "공지사항", MenuType.LIST, ""));
