...
public class ArgumentResolverTest {
    ...
    public void successToInjectJwtTokenIntegerIdIntoArguments() {
        ...
        // jwt 토큰 인증 결과
        List<? extends GrantedAuthority> grantedAuthorities = List.of(new SimpleGrantedAuthority("ROLE_TEST"));
        JwtAuthenticationToken authentication = JwtAuthenticationToken.of(1L, "Nodata", grantedAuthorities);
