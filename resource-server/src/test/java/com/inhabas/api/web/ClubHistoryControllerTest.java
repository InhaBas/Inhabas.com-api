...
public class ClubHistoryControllerTest {
    ...
    void getClubHistories() throws Exception {
        ...
        //when
        String response = mvc.perform(get("/club/histories"))
    ...
    void findClubHistory() throws Exception {
        ...
        //when
        String response = mvc.perform(get("/club/history/{clubHistoryId}", 1L))
                .andExpect(status().isOk())
                .andReturn()
                .getResponse()
                .getContentAsString(StandardCharsets.UTF_8);
    ...
    void findClubHistory_Invalid_Input() throws Exception {
        ...
        //when
        String response = mvc.perform(get("/club/history/{clubHistoryId}", "invalid"))
    ...
    void writeClubHistories() throws Exception {
        ...
        //when
        String header = mvc.perform(post("/club/history")
    ...
    void writeClubHistories_Invalid_Input() throws Exception {
        ...
        //when
        String response = mvc.perform(post("/club/history")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonOf(saveClubHistoryDto)))
                .andExpect(status().isBadRequest())
                .andReturn()
    ...
    void updateClubHistory() throws Exception {
        ...
        //when then
        mvc.perform(put("/club/history/{clubHistoryId}", 1)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonOf(saveClubHistoryDto)))
    ...
    void updateClubHistory_Invalid_Input() throws Exception {
        ...
        SaveClubHistoryDto saveClubHistoryDto = SaveClubHistoryDto.builder()
                ...
                .dateHistory(LocalDateTime.now())
                .build();
        doThrow(InvalidInputException.class).when(clubHistoryService).updateClubHistory(any(), any(), any());

        //when
        String response = mvc.perform(put("/club/history/{clubHistoryId}", 1L)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(jsonOf(saveClubHistoryDto)))
                .andExpect(status().isBadRequest())
                .andReturn()
    ...
    void updateClubHistory_Not_Found() throws Exception {
        ...
        SaveClubHistoryDto saveClubHistoryDto = SaveClubHistoryDto.builder()
                ...
                .dateHistory(LocalDateTime.now())
                .build();
        doThrow(NotFoundException.class).when(clubHistoryService).updateClubHistory(any(), any(), any());
    ...
    void deleteClubHistory_Invalid_Input() throws Exception {
        ...
        //when
        String response = mvc.perform(delete("/club/history/{clubHistoryId}", "invalid"))
                .andExpect(status().isBadRequest())
                .andReturn()
                .getResponse()
                .getContentAsString(StandardCharsets.UTF_8);
    ...
    void deleteClubHistory_Not_Found() throws Exception {
        ...
        //when
        String response = mvc.perform(delete("/club/history/{clubHistoryId}", 1L))
                .andExpect(status().isNotFound())
                .andReturn()
                .getResponse()
                .getContentAsString(StandardCharsets.UTF_8);
