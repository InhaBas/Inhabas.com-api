...
public class MemberControllerTest {
    ...
    public void getUnapprovedMembers() throws Exception {
        ...
        NotApprovedMemberManagementDto dto1 = new NotApprovedMemberManagementDto(
                "홍길동", 1L, "12171707",
                "010-1234-2345", "abc1234@gmail.com", UNDERGRADUATE, 1, "컴퓨터공학과");
        dtoList.add(dto1);
    ...
    public void passOrFailUnapprovedMembers(String state) throws Exception {
        ...
        if (state.equals("pass") || state.equals("fail")) {
            ...
            //when
            doThrow(new InvalidInputException()).when(memberManageService).updateUnapprovedMembers(anyList(), anyString());
            //then
            mvc.perform(put("/members/unapproved")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(jsonOf(new UpdateRequestDto(memberIdList, state))))
    ...
    public void getUnapprovedMemberApplication() throws Exception {
        ...
        ApplicationDetailDto applicationDetailDto = new ApplicationDetailDto(
                1L, "조승현", 1, "컴공", "123@123", "010-1111-2222",
                LocalDateTime.now(), questionAnswerDtoList);
    ...
    public void getNotGraduatedMembers() throws Exception {
        ...
        ApprovedMemberManagementDto dto1 = new ApprovedMemberManagementDto(
                "홍길동", 1L, "12171707",
                "010-1234-2345", UNDERGRADUATE, BASIC, 1, "컴퓨터공학과");
        dtoList.add(dto1);
    ...
    public void getGraduatedMembers() throws Exception {
        ...
        ApprovedMemberManagementDto dto1 = new ApprovedMemberManagementDto(
                "홍길동", 1L, "12171707",
                "010-1234-2345", GRADUATED, BASIC, 1, "컴퓨터공학과");
        dtoList.add(dto1);
    ...
    public void updateApprovedMembers(String roleString) throws Exception {
        ...
        if (roleString.equals("ADMIN")) {
            ...
            given(memberRepository.findAllById(memberIdList)).willReturn(members);
            //then
            mvc.perform(put("/members/approved/role")
                            .contentType(MediaType.APPLICATION_JSON)
                            .content(jsonOf(new UpdateRoleRequestDto(memberIdList, Role.ADMIN))))
                    .andExpect(status().isNoContent());
        } else if (roleString.equals("SIGNING_UP")) {
            //when
            doThrow(new InvalidInputException()).when(memberManageService).updateApprovedMembersRole(anyList(), any());
            //then
            mvc.perform(MockMvcRequestBuilders.put("/members/approved/role")
                            .contentType(MediaType.APPLICATION_JSON)
