...
public class MemberControllerTest {
  ...
  public void getUnapprovedMembers() throws Exception {
    ...
    NotApprovedMemberManagementDto dto1 =
        new NotApprovedMemberManagementDto(
            "홍길동", 1L, "12171707", "010-1234-2345", "abc1234@gmail.com", 1, "컴퓨터공학과");
    dtoList.add(dto1);
  ...
  public void getUnapprovedMemberApplication() throws Exception {
    ...
    AnswerDto dto1 = new AnswerDto(1L, "안녕하세요. 예 안녕히계세요.");
    dtoList.add(dto1);
  ...
  public void getApprovedMembers() throws Exception {
    ...
    ApprovedMemberManagementDto dto1 =
        new ApprovedMemberManagementDto("홍길동", 1L, "12171707", "010-1234-2345", BASIC, 1, "컴퓨터공학과");
    dtoList.add(dto1);
  ...
  public void updateApprovedMembers(String roleString) throws Exception {
    ...
    if (roleString.equals("ADMIN")) {
      ...
      doThrow(new InvalidInputException())
          .when(memberService)
          .updateApprovedMembers(anyList(), any());
      // then
      mvc.perform(
              MockMvcRequestBuilders.put("/members/approved")
                  .contentType(MediaType.APPLICATION_JSON)
