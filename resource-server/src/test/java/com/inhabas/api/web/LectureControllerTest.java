...
public class LectureControllerTest {
  ...
  //                new LectureListDto(1, "title1", 1000001, "intro1", LocalDateTime.of(2001, 1, 1,
  // 1, 1, 1), LectureStatus.PROGRESSING, 1, 30, 2),
  //                new LectureListDto(2, "title2", 1000002, "intro2", LocalDateTime.of(2002, 2, 2,
  // 2, 2, 2), LectureStatus.PROGRESSING, 1, 31, 3),
  //                new LectureListDto(3, "title3", 1000003, "intro3", LocalDateTime.of(2003, 3, 3,
  // 3, 3, 3), LectureStatus.PROGRESSING, 1, 32, 4)
  //        );
  //        PageImpl<LectureListDto> page = new PageImpl<>(list, PageRequest.of(0, 6,
  // Sort.Direction.DESC, "apply_deadline"), list.size());
...
//  }
  ...
  //                new PageImpl<>(students.subList(50, students.size()), PageRequest.of(2, 25,
  // Sort.Direction.ASC, "memberId"), students.size());
