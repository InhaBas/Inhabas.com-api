...
public class FileUtil {
    ...
    private static final String[] RESERVED_NAMES = {"con", "nul", "prn", "aux", "com1", "com2", "com3", "com4", "lpt1", "lpt2", "lpt3", "lpt4"};
    private static final String[] DANGEROUS_EXTENSIONS = {"exe", "bat", "cmd", "sh", "js", "jsp", "php", "asp", "html"};
