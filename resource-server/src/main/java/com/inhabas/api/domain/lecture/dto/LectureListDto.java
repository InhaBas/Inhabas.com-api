...
public class LectureListDto {
    ...
    @Builder
    public LectureListDto(Integer lectureId, String title, Integer chiefId, String introduction, LocalDateTime applyDeadline, LectureStatus status, Integer method, Integer participantsLimits, Integer theNumberOfCurrentParticipants) {
