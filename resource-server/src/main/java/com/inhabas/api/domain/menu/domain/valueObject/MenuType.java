...
public enum MenuType {
  ...
  // 장학회
  SCHOLARSHIP(ANONYMOUS, EXECUTIVES, ANONYMOUS, ADMIN, ADMIN),
  // 후원 내용
  SPONSOR(ANONYMOUS, EXECUTIVES, ANONYMOUS, EXECUTIVES, ANONYMOUS),
  // 사용 내역
  USAGE(ANONYMOUS, EXECUTIVES, ANONYMOUS, EXECUTIVES, ANONYMOUS),
