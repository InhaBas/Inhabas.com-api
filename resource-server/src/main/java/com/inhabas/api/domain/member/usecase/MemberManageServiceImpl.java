...
public class MemberManageServiceImpl implements MemberManageService {
    ...
    private static final Set<Role> CHIEF_CHANGEABLE_ROLES = Set.of(ADMIN, CHIEF, VICE_CHIEF, EXECUTIVES, SECRETARY, BASIC, DEACTIVATED);
    ...
    private void validateMemberRolesToUpdate(Authentication authentication, List<Long> memberIdList, Role role) {
        List<Member> members = memberRepository.findAllById(memberIdList);
