...
public class LectureDetailDto {
    ...
    @Builder
    public LectureDetailDto(Integer id, String title, MemberInfo chief, LocalDateTime applyDeadLine, String daysOfWeeks, String place, String introduction, String curriculumDetails, Integer participantsLimits, Integer method, LectureStatus state, String rejectReason, Boolean paid, LocalDateTime created, LocalDateTime updated) {
        this.id = id;
        this.title = title;
        this.chief = chief;
