...
public class MemberProfileServiceImpl implements MemberProfileService {
    ...
    public List<UpdateNameRequestDto> getMyInfoMyRequests(Long memberId) {
        ...
        return updateNameRequestList.stream().map(request ->
    ...
    public List<UpdateNameRequestDto> getMyInfoRequests() {
        ...
        List<UpdateNameRequest> updateNameRequestList = updateNameRequestRepository.findAllOrderByStatusAndDateRequested();
    ...
    public void handleMyInfoRequest(HandleNameRequestDto handleNameRequestDto) {
        ...
        UpdateNameRequest updateNameRequest = updateNameRequestRepository.findById(handleNameRequestDto.getId())
                .orElseThrow(NotFoundException::new);

        updateNameRequest.handleRequest(handleNameRequestDto.getStatus(), handleNameRequestDto.getRejectReason());
