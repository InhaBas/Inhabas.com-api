...
/**
 * OAuth 2.0 인증이 끝난 후에, 로그인하려는 유저에게 부여할 권한을 결정한다.
 * 아래와 같은 상황에서는, 이 인터페이스를 상속받아서 구현해야한다. <br>
 *
 * <ol>
 *     <li>기존 회원인지 아닌지를 확인하고 그에 따른 권한을 부여할 때</li>
 *     <li>회원 등급에 따라 다른 권한을 부여하고 싶을 때</li>
