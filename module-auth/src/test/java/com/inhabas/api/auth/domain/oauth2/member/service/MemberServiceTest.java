...
public class MemberServiceTest {
  ...
  void getNotApprovedMembersBySearchAndRoleTest() {
    ...
    // then
    assertThat(notApprovedMemberManagementDtos.get(0).getMemberId())
        .isEqualTo(notApprovedMemberManagementDto.getMemberId());
  }
  ...
  void getApprovedMembersBySearchAndRole() {
    ...
    given(memberRepository.findAllByRolesInAndStudentIdLike(any(), any()))
    ...
    // then
    assertThat(approvedMemberManagementDtos.get(0).getMemberId())
        .isEqualTo(approvedMemberManagementDto.getMemberId());
  }
