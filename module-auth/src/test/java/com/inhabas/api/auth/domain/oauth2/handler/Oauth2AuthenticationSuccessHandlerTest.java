...
public class Oauth2AuthenticationSuccessHandlerTest {
  ...
  @InjectMocks private Oauth2AuthenticationSuccessHandler successHandler;

  @Mock private TokenUtil tokenUtil;

  @Mock private HttpCookieOAuth2AuthorizationRequestRepository requestRepository;
  ...
  public void unAuthorizedTargetUrlTest() {
    ...
    Assertions.assertThrows(
        UnauthorizedRedirectUrlException.class,
        () -> successHandler.onAuthenticationSuccess(request, response, authenticationToken));
  }
