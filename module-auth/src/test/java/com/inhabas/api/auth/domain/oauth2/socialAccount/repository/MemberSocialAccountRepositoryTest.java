...
public class MemberSocialAccountRepositoryTest {
    ...
    public void getStudentIdBySocialAccount() {
        ...
        memberSocialAccountRepository.save(new MemberSocialAccount(member, "my@gmail.com", "1234", GOOGLE));
    ...
    public void checkSignUp() {
        ...
        Optional<MemberSocialAccount> memberSocialAccount =
                memberSocialAccountRepository.findMemberSocialAccountByEmailAndProvider(new Email("my@gmail.com"), GOOGLE);

        //when
        boolean check = memberSocialAccountRepository.existsByMember_Id(memberSocialAccount.get().getMember().getId());
