...
public class MemberAuthorityProviderTest {
  ...
  @InjectMocks private MemberAuthorityProvider memberAuthorityProvider;

  @Mock private MemberRepository memberRepository;

  @Mock private MemberPrincipalService memberPrincipalService;
  ...
  public void memberLoginTest() {
    ...
    MemberAuthorityProvider.RoleDto roleDto = new MemberAuthorityProvider.RoleDto(Role.BASIC);
  ...
  public void cannotFindProfileMappedFromSocialAccount() {
    ...
    assertThat(simpleGrantedAuthorities)
        .containsExactly(new SimpleGrantedAuthority("ROLE_SIGNING_UP"));
  }
}
