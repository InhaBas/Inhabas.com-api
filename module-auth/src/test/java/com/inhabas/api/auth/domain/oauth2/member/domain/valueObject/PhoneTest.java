...
public class PhoneTest {
  ...
  public void Phone_is_Wrong() {
    // given
    String[] wrongNumbers = {
      "010-111-1111", "011-1111-1111", "02-503-1234", "010)111-1111", "01023452345"
    };

    // then
    Arrays.stream(wrongNumbers)
        .forEach(number -> assertThrows(InvalidInputException.class, () -> new Phone(number)));
  }

  @DisplayName("핸드폰 번호에 null 이 저장될 수 없다.")
  @Test
  public void Phone_cannot_be_Null() {
    assertThrows(InvalidInputException.class, () -> new Phone(null));
  }

  @DisplayName("핸드폰 번호에 빈 문자열이 저장될 수 없다.")
  @Test
  public void Phone_cannot_be_Blank() {
    assertThrows(InvalidInputException.class, () -> new Phone("  "));
  }
}
