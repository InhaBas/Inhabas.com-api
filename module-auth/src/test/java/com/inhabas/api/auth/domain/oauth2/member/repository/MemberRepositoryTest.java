...
public class MemberRepositoryTest {
    ...
    public void find_by_provider_uid() {
        ...
        //when
        Optional<Member> member = memberRepository.findByProviderAndUid(GOOGLE, new UID("1249846925629348"));
    ...
    public void validateAllFields() {
        ...
        //when
        boolean result = memberRepository.isDuplicated(new MemberDuplicationQueryCondition(GOOGLE, "1249846925629348"));
